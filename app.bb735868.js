...
var htr = function __htr(form) {
  return !Array.isArray(form) ? form : _mithril.default.apply(window, form.slice(0, 2).concat(form.slice(2).map(__htr)));
};
...
var NewEntryCard = {
  view: function NewEntryCard_view() {
    return htr(["div", {
      ...
      className: "absolute inset-l-0 ml-4 p-4 text-purple-400 font-weight-700"
    }, "more"], ["div", {
      className: "absolute inset-r-0 mr-4 p-4 bg-purple-400 text-gray-100 font-weight-700 shadow-md"
    }, "enter"]]]);
  }
};
var RecentEntriesCard = {
  view: function RecentEntriesCard_view() {
    return htr(["div", {
      ...
      className: STYLES.container_header + "text-green-400"
    }, "recent entries"], ["div", {
      className: "grid",
      style: {
      ...
      className: "border-none border-b border-gray-300 p-2 mr-2"
    }, "$12.29"], ["div", {
      className: "border-none border-b border-gray-300 p-2 ml-2"
    }, "chipotle"], ["div", {
      className: "border-none border-b border-gray-300 p-2 mr-2"
      ...
      className: "p-4 text-purple-400 font-weight-700"
    }, "more"]]]);
  }
};
var App = {
  view: function App_view() {
    return React.createElement("div", {
      class: "h-100 bg-gray-100 text-rg font-weight-400"
    }, React.createElement("div", {
      class: STYLES.header
    }, "pinch"), React.createElement(NewEntryCard, null), React.createElement(RecentEntriesCard, null));
  }
}; //m.render($("#app-container"), "Hello world!");

_mithril.default.mount($("#app-container"), App);
},{"mithril":"../node_modules/mithril/index.js"}]},{},["app.jsx"], null)
